...
import { ArrowLeft, AlertCircle, Loader2, Clock, FileText, ChevronDown } from "lucide-react"
...
export default function CreateClinicServicePage() {
    ...
    // Lắng nghe sự kiện click ngoài khung để tự đóng Dropdown
    useEffect(() => {
    ...
    // Lấy nhãn hiển thị trên ô Select
                ...
                <form onSubmit={handleSubmit} className="block space-y-5 w-full min-w-0">
                    ...
                    <div className="block w-full space-y-3">
                        ...
                        <div className="relative w-full" ref={dropdownRef}>
                            ...
                            {/* Popup danh sách dịch vụ với chiều cao cố định và thanh cuộn */}
                            {isOpenDropdown && (
                        ...
                        {/* Ô tự nhập khi chọn "Dịch vụ khác" */}
