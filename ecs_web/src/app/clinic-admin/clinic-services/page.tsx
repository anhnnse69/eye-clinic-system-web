            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-slate-50/70 border-b border-slate-200 text-slate-500 font-bold uppercase tracking-wider">
                  <th className="p-4 pl-6">{t("serviceNameLabel")}</th>
              ...
              <tbody className="divide-y divide-slate-100 text-sm text-slate-700">
                {loading ? (
                  ...
                  servicesList.map((service) => (
                    <tr key={service.id_service} className="hover:bg-slate-50/50 group transition-colors">
                      ...
                      <td className="p-4 text-slate-600">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-medium">{service.durationMinutes} {t("minutes")}</span>
                        </div>
                      </td>
                      ...
                      <td className="p-4 text-center">
                        <div className="flex flex-col items-center justify-center gap-1">
                          ...
                          <span className={`text-[11px] font-bold ${
                            service.isActive ? "text-emerald-600" : "text-slate-500"
                          }`}>
