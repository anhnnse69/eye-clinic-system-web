...
export default async function SystemAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Đã chuyển toàn bộ danh mục sang tiếng Việt
  const sections: NavSection[] = [
    {
      title: "Hệ thống",
      items: [
        { label: "Tổng quan hệ thống", href: "/system-admin/dashboard", icon: "LayoutDashboard" },
      ],
    },
    {
      title: "Phòng khám",
      items: [
        { label: "Đơn đăng ký phòng khám", href: "/system-admin/applications", icon: "FileText" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Thông tin tài khoản", href: "/system-admin/account-info", icon: "User" },
      ],
    },
  ]
