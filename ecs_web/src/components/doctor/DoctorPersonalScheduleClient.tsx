    ...
    return (
        <div className="space-y-6 w-full min-w-0 px-4 py-4">
            ...
            <div className="flex flex-wrap gap-4 bg-slate-50 p-3 rounded-xl border border-slate-200 text-xs font-medium text-slate-600">
                <div className="flex items-center gap-1.5"><div className="w-3 h-3 rounded bg-green-50 border border-green-300"></div><span>Còn trống</span></div>
                ...
                <div className="flex items-center gap-1.5"><div className="w-3 h-3 rounded bg-rose-50 border border-rose-200"></div><span>Khóa/Chặn</span></div>
...
function SlotCell({
    ...
    // BLOCKED — ưu tiên cao nhất, bất kể count
    if (effectiveStatus === SlotStatus.BLOCKED) {
        return (
            <div className="w-full min-h-[80px] p-2 rounded-xl bg-rose-50 border border-rose-100 flex flex-col items-center justify-center">
    ...
    // BOOKED — kín lịch, hiển thị danh sách BN
    ...
    // AVAILABLE — còn trống
    return (
        <div className="w-full min-h-[80px] p-2 rounded-xl bg-green-50 border border-green-200 flex flex-col items-center justify-center">
