...
export default function PatientDemographicsClient({ patientProfileId }: PatientDemographicsClientProps) {
  ...
  const recordTypeOptions: { value: RecordTypeFilter; label: string }[] = [
    { value: "", label: "Tất cả" },
